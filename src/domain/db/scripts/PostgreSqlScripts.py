class PostgreSqlScripts:
  ...
  CREATE_TABLE_PATENT = "CREATE TABLE IF NOT EXISTS patent(patent_id INT PRIMARY KEY NOT NULL UNIQUE, author VARCHAR(60) NOT NULL, classification VARCHAR(50) NOT NULL, registered_at TIMESTAMP NOT NULL)"
  ...
  INSERT_INTO_PATENT = "INSERT INTO patent (patent_id, author, classification, registered_at) VALUES(%s,%s,%s,%s)"
